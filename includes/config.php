...
$mysql_db_route_array_two['db_prefix']="mmall_0000";//数据库前缀，生成类似db_order_0001、db_order_0002......db_order_1023
...
$db_read_host_array=array();
$db_read_host_array['mmall_0000']=DB_HOST.",".DB_HOST;
...
$mysql_db_route_goods_array['db_prefix']="mmall_0000";//数据库前缀，生成类似db_order_0001、db_order_0002......db_order_1023
$mysql_db_route_goods_array['table_prefix']="order_goods_0000";//表名前缀，生成类似order_0001、order_0002......order_1023
...
$mysql_db_route_goods_array['read_db_hosts']=$db_goods_read_host_array;//每个读库存放在哪个host
/*****************************/
