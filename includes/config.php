...
$sc_refund_info_multiple_dbroute_config['db_logic_column'] = "user_id"; //分表的列，执行sql语句时，要传递此参数
...
$monthofyear_multiple_dbroute_config['db_prefix'] = "mmall"; //数据库前缀，生成类似sc_refund_0000、sc_refund_0001...sc_refund_1023
...
$monthofyear_multiple_dbroute_config['table_logic_column'] = "user_id"; //分表的列，执行sql语句时，要传递此参数
